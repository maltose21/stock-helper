...
def build_precise_knowledge_base():
    ...
    knowledge_base = {
        "metadata": {
            ...
            "date_range": f"{articles[-1]['date']} ~ {articles[0]['date']}"
        },
    ...
    # 保存
    output_file = OUTPUT_DIR / "knowledge_base_precise.json"
